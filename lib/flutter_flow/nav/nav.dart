...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const SearchPageWidget() : const HomeDupeWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'activity',
          path: '/activity',
          builder: (context, params) => const ActivityWidget(),
        ),
        FFRoute(
          name: 'delivery',
          path: '/delivery',
        ...
        FFRoute(
          name: 'AuthNameAndPassword',
          path: '/lastSteps',
          builder: (context, params) => const AuthNameAndPasswordWidget(),
        ),
        FFRoute(
          name: 'SearchPage',
          path: '/searchPage',
        ...
        FFRoute(
          name: 'HomeDupe',
          path: '/homeDupe',
          builder: (context, params) => const HomeDupeWidget(),
        ),
        FFRoute(
          name: 'List05Products',
          path: '/list05Products',
